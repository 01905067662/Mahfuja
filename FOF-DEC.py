...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  #os.system(f'xdg-open https://www.facebook.com/SAJU.CHOWDHURY2.0')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/01905067662/Approve.txt/blob/main/README.md").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801905067662?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "᯾".join(uuid)
	server = requests.get(f'https://github.com/01905067662/Approve.txt/blob/main/README.md').text
	try:
		httpCaht = requests.get(f"https://github.com/01905067662/Approve.txt/blob/main/README.md").text
		if id in httpCaht:
			msg = str(os.geteuid())
